...
<head>
<meta charset="UTF-8">
<title>Register for Non-Technical Events</title>
<!-- Bootstrap CSS -->
...
<div class="container">
  <h2>Register for Non-Technical Events</h2>

  <!-- Non-Technical Events Gallery -->
  <div class="row">
    <% 
      ...
      try {
        ...
        String sql = "SELECT * FROM events WHERE event_type = 'Non-Technical'";
    ...
    <div class="col-md-4 mb-4">
      <div class="card">
        ...
        <div class="card-body">
          ...
          <a href="registerevent?eventId=<%= eventId %>&eventType=Non-Technical" class="btn btn-primary">Register</a>
